...
_pastaFotosExtração = r'...\FotosParaExtração' #Caminho absoluto das fotos
_Ortomosaico = r'...\Ortomosaico\Ortomosaico.tif' #Caminho absoluto para o ortomosaico
_SimpleLog = False                                 #True caso você queira que o tempo seja printado na tela, false caso não queira que as informações sejam printadas na tela
...
_aresta  = 50                                      #Tamanho da aresta do quadrado em metros
...
if _SimpleLog: print(f"inicio etapa 5 'ortomosaico'")
